...
public class DbEnvPool {
    ...
    /* Block the Environment creation, unit tests only. */
    private TestHook<CountDownLatch> beforeFinishInitHook;
    ...
    public EnvironmentImpl getEnvironment(File envHome,
         ...
         *
         * If finishInit() fails in any way, make sure the environment is
         * removed from the envs and sharedCacheEnvs maps. If it isn't, it will
         * block all future attempts to create the environment.
         */
        TestHookExecute.doHookIfSet(beforeFinishInitHook);
